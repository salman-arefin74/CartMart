<?php   
 ...
 {  
      if(isset($_SESSION["shopping_cart12"]))  
      {  
           $item_array_id = array_column($_SESSION["shopping_cart12"], "item_id");  
           if(!in_array($_GET["id"], $item_array_id))  
           {  
                $count = count($_SESSION["shopping_cart12"]);  
                $item_array = array(  
                     'item_id'               =>     $_GET["id"],  
                ...
                $_SESSION["shopping_cart12"][$count] = $item_array;  
           }  
           else  
           {  
                echo '<script>alert("Item Already Added")</script>';  
                echo '<script>window.location="westeros.php"</script>';  
           }  
      }  
      else  
      {  
           ...
           $_SESSION["shopping_cart12"][0] = $item_array;  
      }  
 }  
 ...
 {  
      ...
      {  
           foreach($_SESSION["shopping_cart12"] as $keys => $values)  
           {  
                if($values["item_id"] == $_GET["id"])  
                {  
                     unset($_SESSION["shopping_cart12"][$keys]);  
...
<header class="tm-header" >
	...
	<br />  
           <div id="holder">  
                ...
                <?php  
                $query = "SELECT * FROM westeros ORDER BY id ASC";  
                ...
                ?>  
                <div>  
                     <form method="post" action="westeros.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div id="box1">  
...
<div style="clear:both"></div> 
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <?php   
                          if(!empty($_SESSION["shopping_cart12"]))  
                          {  
                               $total = 0;  
                               foreach($_SESSION["shopping_cart12"] as $keys => $values)  
                               {  
                          ...
                          <tr>  
                               ...
                               <td><a href="westeros.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
