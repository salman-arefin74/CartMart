 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="bking.php"</script>';  
           }  
      }  
      else  
      {  
...
<header class="tm-header" >
	...
	<br />  
           <div id="holder">  
                ...
                <?php  
                $query = "SELECT * FROM burger_king ORDER BY id ASC";  
                ...
                ?>  
                <div>  
                     <form method="post" action="bking.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div id="box1">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="bking.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
